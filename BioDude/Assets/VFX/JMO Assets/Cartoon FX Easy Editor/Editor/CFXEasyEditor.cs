...
namespace VFX.JMO_Assets.Cartoon_FX_Easy_Editor.Editor
{
	public class CFXEasyEditor : EditorWindow
	{
		...
		private ParticleSystemModule[] modulesToCopy = {
...
//		GUILayout.Space(6);
			...
			if(copyFoldout)
			{
				...
				{
					for(var i = 0; i < modulesToCopy.Length; i++) modulesToCopy[i].selected = false;
				}
				GUILayout.EndHorizontal();
		...
		private string[] PropertiesToScale = {
			//Initial

using UnityEditor;
using UnityEngine;
using VFX.JMO_Assets.WarFX.Spawn_System;

// Cartoon FX  - (c) 2012-2016 Jean Moreno

// CFX Spawn System Editor interface

namespace VFX.JMO_Assets.WarFX.Editor
{
...
#endif
					ArrayUtility.RemoveAt(ref (target as CFX_SpawnSystem).objectsToPreload, i);
					ArrayUtility.RemoveAt(ref (target as CFX_SpawnSystem).objectsToPreloadTimes, i);
...
#endif
								ArrayUtility.Add(ref (target as CFX_SpawnSystem).objectsToPreload, (GameObject)o);
								ArrayUtility.Add(ref (target as CFX_SpawnSystem).objectsToPreloadTimes, 1);
